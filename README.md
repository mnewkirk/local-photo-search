...
| **M18** | Planned | Unknown-face similarity stacking — cluster unknown faces (most have only 1 photo) by embedding similarity, especially within tight time windows, so they can be grouped/stacked even without a named person reference. |
