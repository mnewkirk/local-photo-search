"""TARGETED unmatch of the Calvin TEMPORAL matches on 2026-09-12.

RE-DERIVED 2026-09-14: a `match_faces` sweep on the NAS re-applied them
(match_source='dedupe_unmatched' does not survive match-faces --temporal;
its candidate query is just `person_id IS NULL`). The id list below is
today's Calvin/temporal set, NOT yesterday's pinned 170 — 8 of those have
since been hand-labelled to other boys and must not be touched. The abort
guard caught exactly that, which is why this list was re-derived.
...
FACE_IDS = [
    ...
    503815, 503834, 503845, 503854, 503901, 503917, 503942, 503952,
    503953, 503954, 503995, 503998, 504018, 504033, 504036, 504041,
    504050, 504055, 504063, 504066, 504079, 504082, 504091, 504125,
    504129, 504157, 504163, 504175, 504191, 504198, 504248, 504252,
    504255, 504282, 504297, 504403, 504416, 504463, 504478, 504482,
    504487, 504513, 504519, 504521, 504593, 504616, 504618, 504619,
    504629, 504660, 504668, 504676, 504681, 504703, 504753, 504756,
    504760, 504780, 504784, 504788, 504819, 504836, 504839, 504844,
    504848, 504888, 504898, 504952, 504958, 504960, 504965, 504979,
    504999, 505002, 505007, 505025, 505038, 505058, 505084, 505110,
    505157, 505173, 505187, 505193, 505220, 505247, 505254, 505261,
    505266, 505310, 505314, 505319, 505322, 505329, 505334, 505375,
    505379, 505382, 505436, 505440
]
